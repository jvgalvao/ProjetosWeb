...
$app->get('/produtos', function(){
    ...
    //formatando um arrey no php em formato json
...
$app->get('/carrinho-dados', function(){
    ...
    //Esse comando vai me permitir que os dados já venham formatado com as casas decimais
...
// Add produtos no nosso carrinho
...
$app->post("/carrinho-produto", function(){
    ...
    //O parametro true faz que o json se torne um array
...
//  Consulta no banco MySql, trazer via PHP gerando um JSOM para alimentar o ANGULAR.