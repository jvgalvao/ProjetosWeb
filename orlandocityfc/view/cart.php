...
<section  ng-controller="cart-controller">
	...
	<div class="container">
		...
		<table id="cart-products" class="table table-bordered">
			<thead><!--Essa tag é utilizada quando voce precisa de linhas e colunas semelhantes -->
				<tr>
			...
			<tbody>
				<tr ng-repeat="produto in produtos">
					...
					<!--Botão de remover os produtos do carrinho-->
...
angular.module("shop", []).controller("cart-controller", function($scope, $http){
	...
	//Remover quantidade do Produto do carrinho
...
//função de carregar tudo do carrinho
	carregarCarrinho();
