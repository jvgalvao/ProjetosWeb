...
<footer>
					...
					<div class="row">
						...
						<div class="col-md-10">
							...
							<div class="row row-cols">
								<!--hidden-xstem a função do bootstrap de esconder qual clase do smartphones-->
								<div class="col-md-4 col-popular-post hidden-xs">
									
									<h4>POPULAR POSTS</h4>

									<ul class="list-unstyled">
									<!--Ultilização da classe para tirar a bolinha pelo bootstrap -->
										<li>
			...
			<div class="row row-cinza-escuro">
				...
				<div class="container copyright-mobile">
					...
					<p class="pull-right text-roxo">Created by João Victor Galvão</p>
